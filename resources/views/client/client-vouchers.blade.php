                                            ...
                                            <div>
                                                ...
                                                @if(!$voucher->active && !$voucher->is_used && !$expired)
                                                    <a class="btn btn-link btn-sm" href="#" data-bs-toggle="modal"
                                                       ...
                                                       data-bs-target="#confirm-activate-voucher-modal{{$voucher->id}}">
                                                ...
                                                @else
                                                    @if(!$voucher->is_used && !$expired)
                                                        ...
                                                        <a class="btn btn-link btn-sm" href="#" data-bs-toggle="modal"
                                                           data-bs-target="#confirm-use-voucher-modal{{$voucher->id}}"
                                                           style=" text-decoration: none;">
                                                            <b style="color: blue;">{{__('Utiliser')}}</b>
                                                        </a>
                                                        <div class="modal fade modal-lg" id="confirm-use-voucher-modal{{$voucher->id}}"
                                                             data-bs-backdrop="static"
                                                             data-bs-keyboard="false" tabindex="-1"
                                                             aria-labelledby="staticBackdropLabel"
                                                             aria-hidden="true">
